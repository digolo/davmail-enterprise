...
public abstract class ExchangeSession {
     ...
     */
    public ExchangeSession(User context, String password) throws IOException {
        this.context = context;
        this.userName = context.getUser();
    ...
    public void purgeOldestTrashAndSentMessages() throws IOException {
        int keepDelay = getUserIntProperty("davmail.keepDelay");
        if (keepDelay != 0) {
    ...
    /**
     * Return internal User context instance
     *
     * @return user context
     */
    ...
    /**
     * Get property value or default, based on User default
     *
    ...
    public String getUserProperty(String property, String defaultValue) {
    	String value = context.getProperties().getProperty(property, defaultValue);
        if (value == null) {
        	Settings.getProperty(property);
        }
        if (value == null) {
            value = defaultValue;
        }
    ...
    /**
     * Get a property value as String, based on User default
     *
     * @param property property name
     * @return property value
     */
    public String getUserProperty(String property) {
    	String value = context.getProperties().getProperty(property);
        if (value == null) Settings.getProperty(property);
    ...
    /**
     * Get a property value as boolean, return default value if null, based on User default
     *
     * @param property     property name
     * @param defaultValue default property value
     * @return property value
     ...
     */
    public boolean getUserBooleanProperty(String property, boolean defaultValue) throws DavMailException {
    	boolean value = defaultValue;
    	try {
            String propertyValue = context.getProperties().getProperty(property);
            if (propertyValue != null && propertyValue.length() > 0) {
                value = Boolean.parseBoolean(propertyValue);
            }
        } catch (NumberFormatException e) {
        	throw new DavMailException("LOG_INVALID_SETTING_VALUE", property);
        }
    	return value;
    }

    /**
     * Get a property value as boolean, based on User default
     *
     * @param property property name
     * @return property value
     * @throws DavMailException 
     */
    public boolean getUserBooleanProperty(String property) throws DavMailException {
    	return getUserBooleanProperty(property, false);
    }

    /**
     * Get a property value as int, return default value if null, based on User default
     *
     * @param property     property name
     * @param defaultValue default property value
     * @return property value
     * @throws DavMailException 
     */
    public int getUserIntProperty(String property, int defaultValue) throws DavMailException {
    ...
    /**
     * Get a property value as int, based on User default
     *
     * @param property property name
     * @return property value
     * @throws DavMailException 
     */
    public int getUserIntProperty(String property) throws DavMailException {
    	return getUserIntProperty(property, 0);
    }
